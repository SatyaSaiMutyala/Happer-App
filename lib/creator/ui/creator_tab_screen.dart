    ...
    try {
      ...
      setState(() {
        if (firstLoad) {
          ...
          _currentPage = 0;
          _hasMoreData = true;
          _hasShownErrorSnackBar = false; // Reset error flag on successful refresh
        }
      ...
      if (mounted && !_hasShownErrorSnackBar) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            action: SnackBarAction(
              ...
              onPressed: () {
                _hasShownErrorSnackBar = false; // Reset flag when retry is pressed
          ...
          Expanded(
            child: RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemCount: selfies.length + (_hasMoreData ? 1 : 0),
                itemBuilder: (context, index) {
                  if (index == selfies.length) {
                    return _isLoading && _searchQuery.isEmpty
                        ? const Padding(
