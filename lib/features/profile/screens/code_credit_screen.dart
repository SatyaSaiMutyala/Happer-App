...
import 'package:happer_app/features/profile/api/code_credit_api.dart';
  ...
  Future<void> _verifyCode() async {
    ...
    if (code.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text(AppLocalizations.of(context).pleaseEnterCode)));
      return;
    }
    ...
    try {
      ...
      if (success) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text(AppLocalizations.of(context).codeVerifiedSuccess)));
