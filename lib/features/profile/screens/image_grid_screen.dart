...
class _ImageGridScreenState extends State<ImageGridScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: HapperAppBar(
        title: userProfile?['users_type'] != 1 ? 'PROFIL' : 'BOUTIQUE CRÉATEUR',
      ),
      body: isLoading
          ? Center(
              child:
                                      ...
                                      child: IconButton(
                                        ...
                                        onPressed: () {
                                          final userName = userProfile != null
                                              ...
                                              : 'this creator';
                                          final encodedId = base64Url.encode(utf8.encode(widget.userId));
                                          final deepLink = 'https://newapi.happer.fr/store/profile/$encodedId';
                                          final shareText =
                                              "J'ai découvert la boutique de mode de $userName sur Happer et j'adore son style \u2728 Je te partage son profil ! $deepLink";
                                          final box = _shareButtonKey.currentContext?.findRenderObject() as RenderBox?;
                                          final origin = box != null ? box.localToGlobal(Offset.zero) & box.size : null;
                                          SharePlus.instance.share(ShareParams(text: shareText, sharePositionOrigin: origin));
                                        },
                                      ),
                                    ),
                                  ],
